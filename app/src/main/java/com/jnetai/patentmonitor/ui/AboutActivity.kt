...
import com.jnetai.patentmonitor.BuildConfig
import com.jnetai.patentmonitor.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareButton.setOnClickListener {
            startActivity(Intent.createChooser(Intent(Intent.ACTION_SEND).apply {
                type = "text/plain"; putExtra(Intent.EXTRA_TEXT, "Check out PatentMonitor! https://github.com/jnetai-clawbot/PatentMonitor")
            }, "Share"))
        }
    }
    private fun checkForUpdates() {
        ...
        Thread {
            try {
                val json = JSONObject(URL("https://api.github.com/repos/jnetai-clawbot/PatentMonitor/releases/latest").readText())
